...
const Login = () => {
  ...
  // Helper to instantly route based on the role returned by backend
  const routeUserByRole = (role, emailStr) => {
    login(role); // Update your global auth context
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Instantly route instead of showing the manual selection screen
      routeUserByRole(data.user.role, email);
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      // Instantly route based on the newly created role
      routeUserByRole(data.user.role, email);
